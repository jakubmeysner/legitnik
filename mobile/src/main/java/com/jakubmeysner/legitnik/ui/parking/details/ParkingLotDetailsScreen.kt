...
fun ParkingGeneralCard(
    ...
    Card(
        ...
        AsyncImage(
            model = imageLink,
            contentDescription = stringResource(R.string.parking_image_description)
        )
        Text(text = stringResource(R.string.parking_address))
        Text(text = address)
        Text(text = stringResource(R.string.parking_free_places))
